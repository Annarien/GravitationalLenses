...
def buildClassifier(input_shape=(100, 100, 3)):
    ...
    classifier.add(Dropout(0.2)) #ADDED THIS BETWEEN THE 2 Conv2D LAYERS
...
def usingCnnModel(training_data, training_labels, val_data, val_labels):
    ...
    """
    model_checkpoint = ModelCheckpoint(filepath=os.path.abspath('best_weights.h5'),
...
classifier.load_weights(os.path.abspath('best_weights.h5'))
classifier.save_weights(os.path.abspath('galaxies_cnn.h5'))
