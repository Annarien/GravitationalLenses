...
def useKerasModel(positiveArray, negativeArray):
    ...
    return (model, xTrain, xTest, yTrain, yTest, description, trainPercent, testPercent, imageTrainStd, imageTrainMean,
            imageTrainShape, imageLabelsShape, xTrainShape, xTestShape, yTrainShape, yTestShape, accuracyScore)


def getKerasKFold(xTrain, xTest, yTrain, yTest):
    # Stratified K fold Cross Validation
    neuralNetwork = KerasClassifier(build_fn=makeKerasModel,
