...
class LensPopulation(LensPopulation_): #extention function because of self.
...
class LensSample():
    ...
    def LoadLensPop(self,j=0,sourcepopulation="lsst"):
        f=open("idealisedlenses/lenspopulation_%s_%s.pkl" % (sourcepopulation, j),'rb')
...
if __name__ == "__main__":
    ...
    Lpop=LensPopulation(reset=True,sigfloor=100,zlmax=2,D=D) # Generate LensPopulation
