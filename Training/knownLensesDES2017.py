...
# get coordinates from known lenses of DES2017.
...
def clipWCSAndNormalise(source, num, gmag, rmag, imag, ra, dec, base_dir = 'DES/DES_Original', base_new = 'KnownLenses/Known_Processed_DESPaper'):
    """
